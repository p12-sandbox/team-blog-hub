        ...
        <ContentWrapper>
          <header className="member-header">
            <div className="member-header__avatar">
              <img src={avatarSrc} alt={name} width={100} height={100} className="member-header__avatar-img" />
            </div>
            ...
            <div className="member-header__links">
              ...
              {suzuriUsername && (
                <a href={`https://suzuri.jp/${suzuriUsername}`} className="member-header__link">
                  <img src="/icons/suzuri.svg" alt={`suzuriのユーザー@${suzuriUsername}`} width={22} height={22} />
                </a>
              )}
              {websiteUrl && (
